...
static_assert(TestParseError<Config>(R"({"text": "\x"})", JsonFusion::JsonIteratorReaderError::ILLFORMED_STRING));
static_assert(TestParseError<Config>(R"({"text": "\z"})", JsonFusion::JsonIteratorReaderError::ILLFORMED_STRING));

// ===== Error: Incomplete unicode escape =====
static_assert(TestParseError<Config>(R"({"text": "\u"})", JsonFusion::JsonIteratorReaderError::ILLFORMED_STRING));
static_assert(TestParseError<Config>(R"({"text": "\u123"})", JsonFusion::JsonIteratorReaderError::ILLFORMED_STRING));
static_assert(TestParseError<Config>(R"({"text": "\u12"})", JsonFusion::JsonIteratorReaderError::ILLFORMED_STRING));
