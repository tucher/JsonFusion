...
// ============================================================================
// Test: not_required<> - Field Can Be Absent
// ============================================================================
...
// ============================================================================
// Test: not_required<> - Required Field Must Be Present
// ============================================================================
...
static_assert(test_not_required_required_missing(), "Required field missing causes error");
...
static_assert(test_not_required_other_required_missing(), "Other required field missing causes error");

// ============================================================================
// Test: not_required<> - All Fields Not Required
// ============================================================================
...
// ============================================================================
// Test: not_required<> - Mix of Required and Not Required
// ============================================================================

// Test: Mix - some required, some not
constexpr bool test_not_required_mix_all_present() {
    struct Test {
        int required1;
        int required2;
        int optional1;
...
static_assert(test_not_required_mix_all_present(), "Mix of required and not_required - all present");

// Test: Mix - required present, optional absent
constexpr bool test_not_required_mix_optional_absent() {
    struct Test {
        int required1;
        int required2;
        int optional1;
...
static_assert(test_not_required_mix_optional_absent(), "Mix - required present, optional absent");

// Test: Mix - one required missing
constexpr bool test_not_required_mix_required_missing() {
    struct Test {
        int required1;
        int required2;
        int optional1;
...
static_assert(test_not_required_mix_required_missing(), "Mix - one required missing causes error");
...
// ============================================================================
// Test: not_required<> - Nested Objects
// ============================================================================
...
// Test: Different not_required annotations at different levels
constexpr bool test_not_required_different_levels() {
    struct Inner {
        int inner_required;
        int inner_optional;
    };
...
static_assert(test_not_required_different_levels(), "Different not_required annotations at different levels");

// ============================================================================
// Test: not_required<> - With key<> Annotation
// ============================================================================
...
// ============================================================================
// Test: not_required<> - Single Field
// ============================================================================

// Test: Single field not_required
constexpr bool test_not_required_single_field() {
    struct Test {
        int required;
        int optional;
    };
...
static_assert(test_not_required_single_field(), "Single field not_required");

// ============================================================================
// Test: not_required<> - Empty Object
// ============================================================================

// Test: Empty object with all fields not_required
constexpr bool test_not_required_empty_object() {
    struct Test {
        int field1;
        int field2;
    };
...
static_assert(test_not_required_empty_object(), "Empty object with all fields not_required");

// Test: Empty object with required field - should fail
constexpr bool test_not_required_empty_object_fails() {
    struct Test {
        int required;
        int optional;
    };
    ...
    Annotated<Test, not_required<"optional">> obj{};
    std::string json = R"({})";  // required field missing
    auto result = Parse(obj, json);
    
    return !result && result.validationErrors().error() == SchemaError::missing_required_fields;
}
static_assert(test_not_required_empty_object_fails(), "Empty object with required field - should fail");
